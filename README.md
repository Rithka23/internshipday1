DATASET HAS 15 COLUMNS AND 110528 ROWS.
1.DATA TYPE: changed the datatype 0f the features.
numbers - int
text - text
data feature - date
time feature - time

2.ScheduledDay and AppointedDay feature has both time and date in same cell. I have created seperate column and add time field of the scheduledDay.
